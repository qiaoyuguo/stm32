...
static void gpio_setup(void)
{
    ...
    // My board has four leds, which is at PF6,PF7,PF8,PF9
	...
	gpio_set_mode(GPIOF, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, GPIO8);
	gpio_set_mode(GPIOF, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, GPIO9);
}
...
int main(void)
{
	...
	while (1) {
		...
		gpio_toggle(GPIOF, GPIO8);	/* LED on/off */
